...
public class DetailEnActivity extends AppCompatActivity {
    ...
    TextView txtUserName, txtEmail, txtAddress, txtDayOff, txtExperienceYears, txtSkype, txtPhone, txtSkill, txtTotalProject;
    Button btnBack;
    String englishName, email, address, firstName, lastName, Skype, phone, avatar, nameSkill;
    int salary, experienceYears, totalProject;
    int id;
    ...
    private void addControls() {
        ...
        txtTotalProject = findViewById(R.id.txt_totalProject);
        ...
        Picasso.get().load(avatar)//download URL
                .into(imgProDetail);
    ...
    class DanhSachSanPhamTask extends AsyncTask<Void, Void, ArrayList<Engineers>> {
        ...
        protected void onPostExecute(ArrayList<Engineers> sanPhams) {
            ...
            if (totalProject == 0){
                txtTotalProject.setText(totalProject+"");
            } else if (totalProject == 1){
                txtTotalProject.setText(totalProject+" Project");
            } else if (totalProject > 1){
                txtTotalProject.setText(totalProject+" Projects");
            }
        }
        ...
        protected ArrayList<Engineers> doInBackground(Void... voids) {
            ...
            try {
                ...
                totalProject = jsonArray.getInt("totalProject");
