...
//        fetchStoreItems();
    ...
    private void parseJSON() {
        String url = "http://si-enclave.herokuapp.com/api/v1/projects/groupBy?limit=100&offset=0&status=pending";
    ...
    class DanhSachSanPhamTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                java.net.URL url = new URL("http://si-enclave.herokuapp.com/api/v1/projects/groupBy?limit=100&offset=0&status=pending");// link API
     ...
     */
    class StoreAdapter extends RecyclerView.Adapter<PendingFragment.StoreAdapter.MyViewHolder> {
        ...
        @Override
        public PendingFragment.StoreAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.store_item_row, parent, false);

            return new PendingFragment.StoreAdapter.MyViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(PendingFragment.StoreAdapter.MyViewHolder holder, final int position) {
